...
%% RIGHT SIDE %%
    ...
    \csection{MAJOR PROJECTS}{\small
        \begin{itemize}
            ...
            \href{https://github.com/alberto-rota?tab=repositories}{\textit{this
            GitHub page}}}
            
        \end{itemize} 
        }
    %% PUBLICATIONS %%    
    \csection{\href{https://orcid.org/0000-0001-9609-6294}{RESEARCH PUBLICATIONS}}{\footnotesize
        \begin{itemize}
            ...
            Venturelli I.,  Rancati T., Zunino P., Costantino M.L., Kamm R.D. - [\textit{Pending}]}
         \end{itemize}
    }
    %% CERTIFICATIONS %%
