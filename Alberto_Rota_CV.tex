...
%% LEFT SIDE %%
    ...
    \csection{EDUCATION \vspace{2.5pt}}{\small
        \begin{itemize}
            ...
            Surgery}}. Supervisor: Prof. Elena de Momi, \textit{PhD}}{\textit{September 2020 -
    ...
    \csection{SKILLS}{\small
        \begin{itemize}
            ...
            \newline
            {\footnotesize Programming: \textit{Python, C++, C, MATLAB, C\#} \newline
                AI: \textit{Tensorflow+Keras framework}\newline
                CAD: \textit{AD Inventor, Blender}\newline
...
%% RIGHT SIDE %%
    ...
    \csection{MAJOR PROJECTS}{\small
        \begin{itemize}
            ...
            review)}
            \item \href{https://github.com/alberto-rota/Qura-ECC-Centifugal-Pump-Tester}{\textbf{ECC
    ...
    %% MINOR PROJECTS %%
    \csection{MINOR PROJECTS}{\small
        \begin{itemize}
        \item {\footnotesize References are available at
        \textit{\href{https://github.com/alberto-rota?tab=repositories}{this GitHub page} }}        
        \end{itemize}
    }
    %% PUBLICATIONS %%    
    \csection{\href{https://orcid.org/0000-0001-9609-6294}{RESEARCH PUBLICATIONS}}{\small
        \begin{itemize}
